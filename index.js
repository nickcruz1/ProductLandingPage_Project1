...
function countDownSpecial() {
 

// Set the date we're counting down to
var countDownDate = new Date("August, 2023 15:37:25").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("sale").innerHTML = " Time Until Sale Ends: " + " " + days + " days " + hours + " hours "
  + minutes + " minutes " + seconds + " seconds ";

  // If the count down is finished, write some text
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("sale").innerHTML = "SALE HAS OFFICIALLY ENDED";
  }
}, 1000);
